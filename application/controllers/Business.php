<?php
	...
	class Business extends CI_Controller {
		...
		// 		$data['title'] = $data['biz_name'].' - '.the_config('site_name');
		...
		// public function submit($page = 'local_business_request') {
		...
		// 		$data['page'] = 'Submit Your Business';

		// 		$data['title'] = $data['page'].' - '.the_config('site_name');
		// 		// Meta
